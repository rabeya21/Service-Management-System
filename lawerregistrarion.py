...
class Lregistration:
    def __init__(self, root):
        ...
        # ***************** 1st image********************
        login_bg = Image.open( r"C:\Users\Maysha\Downloads\WhatsApp Image 2021-08-18 at 8.20.22 PM.jpeg" )
        ...
        cmb_ide['values'] = ("Select", "National Id", "Lawyer Id", "Passport Id")
        ...
        self.doctor = Label(frame1, text="Type Of Lawer", font=("times new roman", 15, "bold"), bg="white",fg="black").place( x=305, y=250)

        cmb_doc = ttk.Combobox(frame1,textvariable=self.var_dtype, font=("times new roman", 13), state="readonly", justify=CENTER)
        cmb_doc['values'] = ("Select", "Personal Injury Lawyer", "Bankruptcy Lawyer", "Immigration Lawyer", "Criminal Lawyer", "Tax Lawyer", "General Practice Lawyer", "Divorce lawyer")
    ...
    def register_data(self):
        if self.txt_fname.get() == "" or self.txt_email.get() == "" or self.txt_contact.get() == "" or self.txt_passw.get() == "" or self.txt_cnfrm.get() == "":
            ...
            if row!=None:
                ...
                my_cursor.execute("insert into laweradd values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",(self.ver_idtype.get(),
                                                                                                          self.ver_ids.get(),
                                                                                                          self.var_name.get(),
                                                                                                          self.var_email.get(),
                                                                                                          self.var_mobail.get(),
